...
const createParsedResponseStream = require('./create-parsed-response-stream');
  ...
  return new Promise((resolve, reject) => {
    ...
    function _onResponse(agentRes) {
      ...
      function _resReject(err, extra) {
        agentRes.destroy(err);
        _reject(err, Object.assign({
          resCacheStream: agentRes,
          resHeaders: agentRes.srcHeaders,
      ...
      debug('[proxy.Response] Status: %s\n Headers: %o', agentRes.srcHeaders, agentRes.statusCode);
      ...
      rc.readBody(unzipStream, type, charset)
        .then(body => {
          ...
          new Promise((resolve, reject) => {
            ...
            const resStream = createParsedResponseStream(agentRes, isCacheResponse);
            _resolve(resStream);
          }, (err) => {
